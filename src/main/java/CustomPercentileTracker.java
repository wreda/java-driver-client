...
/**
 * Created by reda on 12/09/16.
 */

public class CustomPercentileTracker implements LatencyTracker {
    private static final Logger logger = LoggerFactory.getLogger(CustomPercentileTracker.class);
     ...
     * @see Builder
     */
    protected CustomPercentileTracker(int opCount,
    ...
    /**
     * Helper class to build {@code CustomPercentileTracker} instances with a fluent interface.
     */
    public static class Builder {
        ...
        public CustomPercentileTracker build() {
            return new CustomPercentileTracker(opCount, highestTrackableLatencyMillis, numberOfSignificantValueDigits,
                    minRecordedValues);
        }
    }
